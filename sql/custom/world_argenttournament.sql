...
DELETE FROM `script_texts` WHERE `entry` IN (-1850000,-1850001,-1850002,-1850003);
INSERT INTO `script_texts` (`npc_entry`, `entry`, `content_default`, `content_loc2`,`comment`) VALUES
(0, -1850004, 'Tenez-vous prêt !', 'Tenez-vous prêt !',''),
(0, -1850005, 'Que le combat commence !', 'Que le combat commence !',''),
(0, -1850006, 'Préparez-vous !', 'Préparez-vous !',''),
(0, -1850007, 'Vous pensez avoir la vaillance en vous ? Nous verrons.', 'Vous pensez avoir la vaillance en vous ? Nous verrons.',''),
(0, -1850008, 'Impressionnante démonstration. Je pense que vous êtes tout à fait en mesure de rejoindre les rangs des vaillants.', 'Impressionnante démonstration. Je pense que vous êtes tout à fait en mesure de rejoindre les rangs des vaillants.',''),
(0, -1850009, 'J\'ai gagné. Vous aurez sans doute plus de chance la prochaine fois.', 'J\'ai gagné. Vous aurez sans doute plus de chance la prochaine fois.',''),
(0, -1850010, 'Je suis vaincue. Joli combat !', 'Je suis vaincue. Joli combat !',''),
(0, -1850011, 'On dirait que j\'ai sous-estimé vos compétences. Bien joué.', 'On dirait que j\'ai sous-estimé vos compétences. Bien joué.',''),
(0, -1850012, 'J\'ai gagné. Vous aurez sans doute plus de chance la prochaine fois.', 'J\'ai gagné. Vous aurez sans doute plus de chance la prochaine fois.','');
